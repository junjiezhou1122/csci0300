...
int main(int argc, char* argv[]) {
  ...
  // Now, half of the threads should be MultiPutting the keys with a value of
  // length 1; the other half should be MultiGetting. If your code is
  // thread-safe, each MultiGetter should only get one value, even though there
  // are multiple concurrent MultiPut requests happening for a given key.
